  ...
  return (
    <div className="contactPage">
      ...
      <div className="contactPage__info">
        ...
        >
          <a href="mailto:contact@romain-marcazzan.fr">
            contact@romain-marcazzan.fr
          </a>
        </motion.div>
        <motion.div
          initial={{ x: 150 }}
        ...
        <div className="contactPage__info__social">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <a
              href="https://www.linkedin.com/in/romain-marcazzan-889bb1159/"
              target="_blank"
              rel="noreferrer"
            >
              <motion.path
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <a
              href="https://github.com/RomainMarcazzan"
              target="_blank"
              rel="noreferrer"
            >
              <motion.path
